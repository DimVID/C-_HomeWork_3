...
int number = InputInt("Введите число N, до которого выдадим кубическое значение: ");  //запуск функции ввода числа number

for (int i = 1; i <= number; i++)   //у цикла for Три параметра: 1- инициализация, 2 - условие продолжение, 3 - команда в конце каждого цикла
{
    int cube = i * i * i;              //заводим переменную = кубическому значению счетчика
    System.Console.Write($"{cube} ");  //вывод куба на экран в одну строку
}
